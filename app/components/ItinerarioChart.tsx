// app/components/ItinerarioChart.tsx
"use client";
...
export default function ItinerarioChart({ data }: { data: ItnItem[] }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
      <style>{`
        .itn-scroll::-webkit-scrollbar { width: 3px; }
        .itn-scroll::-webkit-scrollbar-track { background: transparent; }
        .itn-scroll::-webkit-scrollbar-thumb { background: var(--border); border-radius: 2px; }
        .itn-scroll::-webkit-scrollbar-thumb:hover { background: var(--accent); }
        .bar-seg-tip { cursor: default; transition: filter 0.15s; }
        .bar-seg-tip:hover { filter: brightness(1.4); }
      `}</style>

      {/* Tooltip — fixed na janela, nunca cortado */}
      {tooltip.visible && (
        <div style={{
          position: "fixed",
          left: tooltip.x + 14,
      ...
      {/* Lista com scroll */}
      <div className="itn-scroll" style={{
        overflowY: "auto",
        maxHeight: "260px",
        display: "flex",
